@extends('layouts.app',['title' => 'Withdraw'])
@section('content')
<div class="row">
	...
	<div class="col-md-8">
		...
		<div class="card mb-4">
			...
			<!-- Account -->
			<form id="formAccountSettings" method="POST" action="{{route('withdraw.amount')}}" autocomplete="off" enctype="multipart/form-data" >
				@csrf
				...
				<div class="card-body">
					...
					<div class="mt-2">
						<button type="submit" class="btn btn-primary me-2">Withdraw</button>
